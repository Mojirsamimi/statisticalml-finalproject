...
%%
AdaBoostM1 = fitensemble(TrainData,TrainLabels,'AdaBoostM1',200,'Tree','Cost',[0 1;10 0],'CrossVal','on','KFold',5,'NPrint',10);
[Yfit,AdaScore]=AdaBoostM1.kfoldPredict();
dlmwrite('AdaBoostResult.csv', AdaScore(:,2), 'delimiter', ',', 'precision', 10);
%%
[X,Y,T,AUC] = perfcurve(TrainLabels,AdaScore(:,2),1);
AUC