...
%%
disp('Bag');
bag = fitensemble(TrainData,TrainLabels,'Bag',200,'Tree','Type','Classification','Cost',[0 1;10 0],'nprint',10,'CrossVal','on','KFold',5);

[BAGYfit,BAGscores]=bag.kfoldPredict();
%%
[X,Y,T,AUC] = perfcurve(TrainLabels,BAGscores(:,2),1);
AUC