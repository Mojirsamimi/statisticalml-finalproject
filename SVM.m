...
%%
disp('SVM');
SVM = fitcsvm(TrainData,TrainLabels,'KernelFunction','rbf','Standardize',true,'ClassNames',[0,1],'Cost',[0 1;10 0],'CrossVal','on','KFold',5);

[SVMYfit,SVMscores]=SVM.kfoldPredict();
%%
[X,Y,T,AUC] = perfcurve(TrainLabels,SVMscores(:,2),1);
AUC